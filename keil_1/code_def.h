...
#define GPIO_BASE	(unsigned int)(0x40000020UL)
#define GPIO_ODR	(unsigned int*)(GPIO_BASE+0x00) 
#define GPIO_IDR	(unsigned int*)(GPIO_BASE+0x04) 
#define GPIO_OEN	(unsigned int*)(GPIO_BASE+0x08)
/*	
...
/*typedef struct {
    volatile uint32_t GPIO_ODR; // 0x40000000
    volatile uint32_t GPIO_IDR; // 0x40000004
    volatile uint32_t GPIO_OEN; // 0x40000008
}GPIOType;

#define GPIO_BASE (unsigned int)0x40000000
